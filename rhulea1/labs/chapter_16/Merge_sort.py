...
def merge(numbers, i, j, k):
    global comparisons  # allows modification of global variable
    ...
    while left_pos <= j and right_pos <= k:
        comparisons += 1                  # To count each comparisons
...
if __name__ == "__main__":
    ...
    print(f"comparisons: {comparisons}")    #To display the total number of comparisons
